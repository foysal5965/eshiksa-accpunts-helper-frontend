...
import { modifyPayload } from '@/app/utils/modifyPayload';
...
const CreateAdminPage = () => {
    ...
    const handleRegister = async (values: FieldValues) => {
        ...
        try {
            const res = await addAdminWithFormData(data);
            console.log(res)
            if (res?.data?.data?.id) {
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                <TextField
                                    ...
                                    error={!!errors.admin?.contactNo}
                                    helperText={errors?.admin?.contactNo?.message}
                                />
                            </motion.div>
                        </Grid>
                        <Grid item xs={12}>
